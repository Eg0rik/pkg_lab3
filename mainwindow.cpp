...
void MainWindow::OpenFile()
{
    ...
    QString fileName = fileDialog->getOpenFileName(this, tr("Open Image"), "/Users/mac", tr("Image Files (*.png *.jpg *.bmp *.gif *.tiff *.pcx)"));
...
//Эквализация гистограммы цветовых компонент
...
//Эквализация гистограммы компоненты яркости в цветовом пространстве HSV (
